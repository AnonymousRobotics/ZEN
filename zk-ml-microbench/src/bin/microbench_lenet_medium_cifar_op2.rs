...
use zk_ml_microbench::lenet_circuit::*;
use zk_ml_microbench::pedersen_commit::*;
use zk_ml_microbench::read_inputs::*;
use zk_ml_microbench::vanilla::*;
fn main() {
    ...
    println!("LeNet small optimized level 2  on CIFAR dataset");
