...
impl ConstraintSynthesizer<Fq> for LeNetCircuitU8OptimizedLv3PedersenClassification {
    fn generate_constraints(self, cs: ConstraintSystemRef<Fq>) -> Result<(), SynthesisError> {
        ...
        println!(
            "Current number of LeNetCircuit Classification model parameters commitment constraints {}",
            cs.num_constraints()
        );
        ...
        for i in 0..transformed_conv3_output.len() {
            ...
            let classification_res_var =
                FpVar::<Fq>::new_witness(r1cs_core::ns!(cs, "classification res"), || {
    ...
    fn generate_constraints(self, cs: ConstraintSystemRef<Fq>) -> Result<(), SynthesisError> {
        ...
        for i in 0..transformed_conv3_output.len() {
            ...
            let is_the_same_person_var =
                FpVar::<Fq>::new_witness(r1cs_core::ns!(cs, "is the same person"), || {
